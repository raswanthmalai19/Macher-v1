...
abstract class VocalShieldDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: VocalShieldDatabase? = null
         ...
         */
        fun getDatabase(context: android.content.Context): VocalShieldDatabase {
         ...
         * @return Encrypted VocalShieldDatabase instance
         */
        private fun buildEncryptedDatabase(context: android.content.Context): VocalShieldDatabase {
            // Get secure passphrase from KeyManager
            val passphrase = com.vocalshield.android.util.KeyManager.getDatabasePassphrase(context)
        ...
        fun deleteDatabase(context: android.content.Context) {
            synchronized(this) {
                ...
                val dbFile = context.getDatabasePath("vocalshield_database")
                if (dbFile.exists()) {
                    val deleted = dbFile.delete()
                    if (deleted) {
                        com.vocalshield.android.util.Logger.info(
                            "VocalShieldDatabase",
                            "Database file deleted successfully"
                        )
                    } else {
                        com.vocalshield.android.util.Logger.error(
                            "VocalShieldDatabase",
                ...
                com.vocalshield.android.util.KeyManager.clearAllKeys(context)
