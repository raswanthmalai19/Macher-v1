...
import com.vocalshield.android.demo.ScamScenario
...
fun PreviewCallInfoCardHighRisk() {
    VocalShieldTheme {
        CallInfoCard(
            call = com.vocalshield.android.data.database.CallRecordEntity(
                id = "call-123",
...
fun PreviewRiskDetailModalHighRisk() {
    VocalShieldTheme {
        RiskDetailModal(
            record = com.vocalshield.android.data.database.CallRecordWithRisk(
                call = com.vocalshield.android.data.database.CallRecordEntity(
                    id = "call-789",
                    phoneNumber = "+1 (555) 123-4567",
                ...
                risk = com.vocalshield.android.data.database.RiskAssessmentEntity(
                    id = "risk-789",
                    callId = "call-789",
                    totalScore = 12.5f,
                    riskLevel = "HIGH",
                ...
                triggers = listOf(
                    com.vocalshield.android.data.database.RiskTriggerEntity(
                        id = 1,
