 ...
 * ```
 */
suspend fun VocalShieldDatabase.getCallWithRisk(callId: String): CallRecordWithRisk? {
 ...
 */
suspend fun VocalShieldDatabase.getAllCallsWithRisk(): List<CallRecordWithRisk> {
