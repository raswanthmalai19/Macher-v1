...
import com.macher.android.service.DetectionMode
    ...
    fun `property - risk breakdown conservation in integration flow`() = runTest {
        suspend fun checkBreakdownConservation() {
            ...
            try {
                ...
                val breakdowns = mutableListOf<com.macher.android.service.RiskBreakdown>()
                repeat(5) {
                    delay(100)
        ...
        suspend fun checkProgressBounds() {
            ...
            try {
                ...
                if (scenarios.isNotEmpty()) {
                    ...
                    val progressStates = mutableListOf<com.macher.android.service.ScenarioProgress>()
                    repeat(10) {
                        delay(100)
