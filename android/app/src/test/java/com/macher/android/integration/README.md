# MACHER Integration Tests

This directory contains comprehensive integration tests for the MACHER multi-layer detection system. These tests validate end-to-end workflows and system behavior under various conditions.
...
```bash
./gradlew test --tests "com.macher.android.integration.EndToEndDetectionFlowTest"
./gradlew test --tests "com.macher.android.integration.DemoModeIntegrationTest"
./gradlew test --tests "com.macher.android.integration.FallbackModeIntegrationTest"
./gradlew test --tests "com.macher.android.integration.CallHistoryIntegrationTest"
./gradlew test --tests "com.macher.android.integration.ErrorRecoveryIntegrationTest"
./gradlew test --tests "com.macher.android.integration.IntegrationPropertyTests"
```
...
Ensure `MACHERDatabase.getInMemoryDatabase()` is called in `@Before` setup.
