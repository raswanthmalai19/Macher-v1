...
class FallbackModeIntegrationTest {
    ...
    fun `test detection continues during mode transitions`() = runTest {
        ...
        val statesBeforeTransition = mutableListOf<com.vocalshield.android.detection.DetectionState?>()
        val statesAfterTransition = mutableListOf<com.vocalshield.android.detection.DetectionState?>()
